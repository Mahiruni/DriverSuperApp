...
set local request.jwt.claims = '{"sub":"00000000-0000-0000-0000-000000000001","role":"authenticated","app_metadata":{"role":"customer"}}';
...
select policies_are('public','trips',array['trips_customer_select','trips_customer_insert','trips_customer_cancel','trips_driver_select','trips_driver_update','trips_admin_all'],'trip policies are installed');
select * from finish();
rollback;
